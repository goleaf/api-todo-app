        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-blue-500 selection:text-white">
            @if (Route::has('login'))
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    @auth
                        ...
                        <a href="{{ route('admin.dashboard') }}" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-blue-500">Admin</a>
                    @else
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <div class="mt-8 text-center">
                    <h1 class="text-4xl font-bold text-gray-900 dark:text-white">Todo App</h1>
