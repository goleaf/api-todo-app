            ...
            <div class="flex-1 min-w-0">
                <div class="flex items-center justify-between gap-4">
                    ...
                    <div class="flex items-center gap-2">
                        <x-shared.components.tasks.task-priority :priority="$task->priority_text" />
                        <x-shared.components.tasks.task-status :status="$task->status" />
                    </div>
                </div>
                ...
                <div class="mt-3 flex flex-wrap gap-3">
                    <x-shared.components.tasks.task-category :category="$task->category" />
                    <x-shared.components.tasks.task-tags :tags="$task->tags" />
                </div>

                <div class="mt-4 flex items-center justify-between">
                    <x-shared.components.tasks.due-date :date="$task->due_date" />
