                    ...
                    <form action="{{ route('categories.update', $category) }}" method="POST" class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row g-2">
                                    <div class="col-auto">
                                        <input type="color" name="color" class="form-control form-control-color @error('color') is-invalid @enderror" value="{{ old('color', $category->color) }}" title="Choose category color">
                                    </div>
                                    <div class="col">
                                        <input type="text" name="color_hex" class="form-control @error('color') is-invalid @enderror" value="{{ old('color', $category->color) }}" pattern="^#[0-9A-Fa-f]{6}$" placeholder="#206bc4">
                                    </div>
                                </div>
                                @error('color')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row g-2">
                                    <div class="col">
                                        <input type="text" name="icon" class="form-control @error('icon') is-invalid @enderror" value="{{ old('icon', $category->icon) }}" placeholder="📁">
                                    </div>
                                    <div class="col-auto">
