                ...
                <form action="{{ route('categories.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <div class="flex mt-1">
                                <input type="color" id="color" name="color" value="{{ old('color', '#3B82F6') }}" class="h-10 w-10 rounded">
                                <x-ui.text-input type="text" value="{{ old('color', '#3B82F6') }}" class="ml-2 block w-full" readonly />
                            </div>
