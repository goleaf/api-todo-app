<template>
  <div class="task-card max-w-md mx-auto">
    <h2 class="text-2xl font-semibold mb-8 text-center text-gray-800 dark:text-gray-200">Create Account</h2>
    ...
    <form @submit.prevent="handleSubmit" class="space-y-6">
      <div>
        <label class="block text-gray-700 dark:text-gray-300 text-sm font-medium mb-2" for="name">
          Name
        </label>
        <input 
          v-model="form.name" 
      ...
      <div>
        <label class="block text-gray-700 dark:text-gray-300 text-sm font-medium mb-2" for="password_confirmation">
          Confirm Password
        </label>
        <input 
      ...
      <div class="text-center pt-4 border-t border-gray-200 dark:border-gray-700">
        <router-link to="/login" class="text-[var(--primary)] hover:text-opacity-80 transition-colors">
